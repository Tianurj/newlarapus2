...
class BooksSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	$book3=Book::create(['title'=>'Membingkai Surga Dengan Rumah Tangga','amount'=>4,'author_id'=>$author3->id]);
    	$book4=Book::create(['title'=>'Cinta & Seks Rumah Tangga','amount'=>3,'author_id'=>$author3->id]);
